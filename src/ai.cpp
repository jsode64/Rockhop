...
std::tuple<u64, i32> AI::find_move(Game game, u32 depth) {
    ...
    for (auto move: moves) {
        i32 score = AI::score_move(game, move, depth, SCORE_MIN, SCORE_MAX);
...
__attribute__((hot))
i32 AI::score_move(Game game, u64 move, u32 depth, i32 a, i32 b) {
